...
{
    std::cout<<"shutdown:"<<loop_->getthreadId()<<std::endl;
    if (state_ == kConnected)
    {
...
{
    std::cout<<"connectDestroyed"<<loop_->getthreadId()<<std::endl;
    if (state_ == kConnected)
    {
...
{
    std::cout<<"handleRead"<<loop_->getthreadId()<<std::endl;
    int savedErrno = 0;
...
{
    std::cout<<"handleClose"<<loop_->getthreadId()<<std::endl;
